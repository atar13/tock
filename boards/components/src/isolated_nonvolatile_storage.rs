...
//! -----
//! ```rust
//! let nonvolatile_storage = components::nonvolatile_storage::IsolatedNonvolatileStorageComponent::new(
//!     board_kernel,
...
macro_rules! isolated_nonvolatile_storage_component_static {
    ($F:ty $(,)?) => {{
        ...
        let ns = kernel::static_buf!(
            capsules_extra::isolated_nonvolatile_storage_driver::IsolatedNonvolatileStorage<'static>
        );
...
pub type IsolatedNonvolatileStorageComponentType = IsolatedNonvolatileStorage<'static>;
...
impl<
    ...
    > IsolatedNonvolatileStorageComponent<F>
{
    pub fn new(
        board_kernel: &'static kernel::Kernel,
        driver_num: usize,
